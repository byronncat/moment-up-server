...
const avatarFiles = [
  ...
  'https://pbs.twimg.com/media/Gs6j_R2bsAAL5cL?format=jpg&name=4096x4096',
  'https://pbs.twimg.com/media/Gryah3uXkAAvDtT?format=jpg&name=4096x4096',
  'https://pbs.twimg.com/media/GqpnuaVXAAAYrhH?format=jpg&name=4096x4096',
  'https://pbs.twimg.com/media/GDxlKAwbkAAEEH4?format=jpg&name=4096x4096',
  'https://pbs.twimg.com/media/FbT-hSnaMAITR81?format=jpg&name=4096x4096',
  'https://pbs.twimg.com/media/Fsh9DaOakAEL7B1?format=jpg&name=4096x4096',
  'https://pbs.twimg.com/media/FvWhCjEakAAeQ6C?format=jpg&name=large',
  'https://pbs.twimg.com/media/GKi4QHnboAAJWYV?format=jpg&name=4096x4096',
  'https://pbs.twimg.com/media/FrZfFNvaQAAxuxq?format=jpg&name=4096x4096',
  'https://pbs.twimg.com/media/GFEigYqa0AAqYjf?format=jpg&name=4096x4096',
  'https://pbs.twimg.com/media/F0sW--oWIAQqPqP?format=jpg&name=large',
  'https://pbs.twimg.com/media/FJrSq89UUAIGhDT?format=jpg&name=4096x4096',
  ...
  'https://pbs.twimg.com/media/GllqHMLa4AATGzZ?format=jpg&name=4096x4096',
  'https://pbs.twimg.com/media/GtErX2oaIAAUAwM?format=jpg&name=large',
  'https://pbs.twimg.com/media/Gs_YbumagAAJKWg?format=jpg&name=4096x4096',
  'https://pbs.twimg.com/media/GsxybX8bQAEQ8sW?format=jpg&name=4096x4096',
  'https://pbs.twimg.com/media/GjPNWTNb0AAZvar?format=jpg&name=large',
  'https://pbs.twimg.com/media/GaARflpbEAAGnmH?format=jpg&name=4096x4096',
  'https://pbs.twimg.com/media/Gc6Be8_bkAAXjoB?format=jpg&name=4096x4096',
  'https://pbs.twimg.com/media/GLiajEDboAAnccH?format=jpg&name=large',
  'https://pbs.twimg.com/media/GHvc3k-bEAAtwWN?format=jpg&name=large',
  'https://pbs.twimg.com/media/GEmDEA9bcAAOfmP?format=jpg&name=4096x4096',
  'https://pbs.twimg.com/media/Gdtc9TWWYAA7DUE?format=jpg&name=4096x4096',
  'https://pbs.twimg.com/media/GX4zYoXaUAAb3hr?format=jpg&name=large',
  'https://pbs.twimg.com/media/GLpnRIWa8AAjVjt?format=jpg&name=4096x4096',
  'https://pbs.twimg.com/media/GtbCig-bIAAqvrd?format=jpg&name=4096x4096',
  'https://pbs.twimg.com/media/GtQ6RRjb0AA0ZkV?format=jpg&name=4096x4096',
  'https://pbs.twimg.com/media/GrAW1FlXkAAgu1O?format=jpg&name=large',
  'https://pbs.twimg.com/media/GSapLb6W0AADWqy?format=jpg&name=4096x4096',
  'https://pbs.twimg.com/media/Gt4gzd7XEAAXFTb?format=jpg&name=4096x4096',
  'https://pbs.twimg.com/media/GcZL3OJaAAATqcq?format=jpg&name=4096x4096',
  'https://pbs.twimg.com/media/GDdhBdYbwAA1BIE?format=jpg&name=large',

  'https://pbs.twimg.com/media/GE2MoDBbcAAMPYH?format=jpg&name=large',
];

export function getRandomFile(text: string) {
  const seed = text ? text.split('').reduce((acc, char) => acc + char.charCodeAt(0), 0) : 0;
  return avatarFiles[seed % avatarFiles.length];
}
